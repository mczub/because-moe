...
class Crunchyroll(AnimeSource):
	...
	def __GetData(self, dataProxy):
		...
		crSession.post('https://www.crunchyroll.com/?a=formhandler', params=params, proxies = dataProxy)
		blob = crSession.get('http://www.crunchyroll.com/videos/anime/alpha?group=all', proxies = dataProxy)
...
class Funimation(AnimeSource):
	...
	def UpdateShowList(self, showList, titleMap, proxy):
		...
		return shows
	def __GetData(self, dataProxy):
		blob = requests.get('http://www.funimation.com/videos/episodes', proxies = dataProxy)
...
class Netflix(AnimeSource):
	...
	def __GetData(self):
		...
		headers = {
			'Referer': 'http://unogs.com/search/?q=-!1900,2016-!0,5-!0,10-!7424-!Any-!Any-!Any&cl=33,&st=adv&ob=Relevance',
			'Accept': 'application/json, text/javascript, */*; q=0.01'
		}
		dataBlob = unogsSession.get('http://unogs.com' + cgiUrl + '&q=-!1900,2016-!0,5-!0,10-!7424-!Any-!Any-!Any&t=ns&cl=33,&st=adv&ob=Relevance', headers = headers)
